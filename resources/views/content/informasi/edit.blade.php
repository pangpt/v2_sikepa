...
@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms/</span> Edit Informasi</h4>
...
<div class="row">
  <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body">
              <form action="{{route('informasi-baru-update',['id' => $info->id])}}" method="POST">
                @csrf
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label" for="basic-default-phone">Judul Informasi</label>
                  <div class="col-sm-10">
                    <input type="text" id="judul" name="judul" class="form-control" placeholder="" value="{{$info->judul}}"/>
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label" for="basic-default-message">Isi Informasi</label>
                  <div class="col-sm-10">
                    <textarea id="elm1" name="isi_konten" rows="10">{!! $info->isi_konten !!}</textarea>
                  </div>
                </div>
                <div class="row mb-3">
